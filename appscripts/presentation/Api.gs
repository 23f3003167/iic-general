...
function releasePresentationSlots_(payload) {
  ...
  if (bookingWindowDate && bookingWindowStartTime && bookingWindowEndTime && parseClockTimeMinutes_(bookingWindowEndTime) <= parseClockTimeMinutes_(bookingWindowStartTime)) {
